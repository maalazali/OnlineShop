    ...
    public static void main(String args[]) {
        try {
            ...
            try {
                ...
                String insertSql = "INSERT INTO KundeX (email, username, passwort) VALUES (?, ?, ?)";
                ...
                try{
                    ...
                    for (int i = 101; i <= 2000; i++) {
                        String email = "kunde" + i + "@example.com";
                        String username = "Benutzer" + i;
                        String password = "Passwort" + i;
